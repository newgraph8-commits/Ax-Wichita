        ...
        <section className="pt-48 pb-12 lg:pt-56 lg:pb-16">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-12">
              Ax Cobb unites top-tier legal minds with law firms and corporate legal departments that demand excellence.
                ...
                <div className="space-y-8 w-full">
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed w-full">
                      Organizations rely on Ax Cobb for legal talent that aligns with their operational demands,
                  ...
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed mb-4 w-full">
                      Competition for standout associates intensifies each recruitment cycle. Ax Cobb leverages its
                  ...
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed mb-4 w-full">
                      Partner transitions are complex, high-stakes, and sensitive. Ax Cobb rejects the one-size-fits-all
                  ...
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed mb-4 w-full">
                      ...
                      turn to Ax Cobb when preparing for a strategic career move. Whether they are senior partners
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed w-full">
                      From early strategic advisory through final compensation negotiations, Ax Cobb provides the
