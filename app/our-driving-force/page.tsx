...
export const metadata = {
  title: "Our Driving Force - Ax Wichita",
  description: "Ax Wichita's proprietary A-Frame Intelligence Engine delivers breakthrough outcomes for executive search",
}
